...
from aap.utils import isFactCheck
...
class AAPBulletinBuilderFormatter(Formatter):
    ...
    def format(self, article, subscriber, codes=None):
        ...
        try:
            ...
            formatted_article['body_text'] = self.get_text_content(body_html, formatted_article, isFactCheck(article))
    ...
    def get_text_content(self, content, formatted_article=None, is_fact_check=False):
        ...
        for top_level_tag in parsed.xpath('/html/div/child::*'):
            ...
            if is_fact_check and abstract and not abstract_found:
