...
class AapBulletinBuilderFormatterTest(TestCase):
    ...
    def test_remove_abstract_from_body_for_fact_check(self):
        article = {
            'source': 'AAP',
            'anpa_category': [{'qcode': 'c'}],
            'headline': 'This is a test headline',
            ...
            'type': 'text',
            'format': 'HTML',
            'abstract': '<p>Do eating disorders have the highest mortality rate of any mental illness?</p>',
            'body_html': '<p>Do eating disorders have the highest mortality rate of any mental illness?<br></p>'
                         '<p><b><br></b></p><p><b>The Statement</b></p><p><b>"They have the highest fatality rate '
                         'of any psychiatric disorder, and the system wasn\'t recognising it."</b><br></p>',
            'word_count': '10',
            'priority': 1,
            'urgency': 1,
            'firstcreated': utcnow(),
        ...
        self.assertGreater(int(seq), 0)
        test_article = json.loads(item.get('data'))
        self.assertNotIn('Do eating disorders have the highest mortality rate of any mental illness?',
                         test_article.get('body_text'))

    def test_not_remove_abstract_from_body_for_article(self):
        article = {
            'source': 'AAP',
            'anpa_category': [{'qcode': 'c'}],
            'headline': 'This is a test headline',
        ...
        self.assertGreater(int(seq), 0)
        test_article = json.loads(item.get('data'))
        self.assertIn('Do eating disorders have the highest mortality rate of any mental illness?',
                      test_article.get('body_text'))
